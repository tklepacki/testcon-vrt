...
exports.validateConfig = exports.readConfigFromEnv = exports.readConfigFromFile = void 0;
const fs_1 = require("fs");
const CONFIG_FILE_PATH = "./vrt.json";
const readConfigFromFile = (config) => {
    if ((0, fs_1.existsSync)(CONFIG_FILE_PATH)) {
        const fileConfig = JSON.parse((0, fs_1.readFileSync)(CONFIG_FILE_PATH).toString());
...
exports.readConfigFromEnv = readConfigFromEnv;
